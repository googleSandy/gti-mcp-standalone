...
async def search_threat_actors(
  ...
  """
  res = await _search_threats_by_collection_type(
      query, "threat-actor", ctx, limit, order_by, api_key=api_key)
  return res
...
async def search_threat_reports(
  ...
  """
  res = await _search_threats_by_collection_type(
      query, "report", ctx, limit, order_by, api_key=api_key)
  return res
...
async def search_vulnerabilities(
  ...
  """
  res = await _search_threats_by_collection_type(
      query, "vulnerability", ctx, limit, order_by, api_key=api_key)
  return res
